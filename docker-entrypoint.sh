...
echo -e "\n***** sysinit *****\n"
#rsync -avzH --ignore-existing /root.bak/.bashrc /root/
#rsync -avzH --ignore-existing /root.bak/.bashrc.original /root/
#rsync -avzH --ignore-existing /root.bak/.profile /root/
#rsync -avzH --ignore-existing /root.bak/.zshrc /root/
#rsync -avzH --ignore-existing /root.bak/.face /root/
#rsync -avzH --ignore-existing /root.bak/.face.icon /root/
rsync -avzH --ignore-existing --exclude='.cache' /root.bak/ /root/
